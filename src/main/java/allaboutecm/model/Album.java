...
public class Album extends Entity {
    ...
    private static final String exceptionMessage="Object should not be null.";
    ...
    public Album(int releaseYear, String recordNumber, String albumName) {
        ...
        this.featuredMusicians = new ArrayList<>();
    ...
    public void setFeaturedMusicians(List<Musician> featuredMusicians) {
        ...
        Set<Musician> set = new HashSet<>(featuredMusicians);
    ...
    {
        notNull(tracks,exceptionMessage);
    ...
    {
        notNull(concerts,exceptionMessage);
